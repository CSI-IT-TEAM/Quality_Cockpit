    ...
    public partial class FORM_SMT_WEATHER_MGNT_STATICS : Form
    {
        ...
        private void BindingData(string argType, ChartControl chart)
        {
            try
            {
                ...
                DataTable dt1 = null;
                dt1 = SMT_MAT_WEATHER_MGNT_STATICS(argType, ComVar.Var._strValue5.Split('_')[0].ToString(), ComVar.Var._strValue2, dtp_Ym.DateTime.ToString("yyyyMMdd"), ComVar.Var._strValue3);
