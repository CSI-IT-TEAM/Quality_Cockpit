...
namespace FORM.UC
{
    public partial class UCTitle : UserControl
    {
        ...
        {
            ComVar.Var._strValue4 = this.Tag.ToString();
            ComVar.Var._strValue5 = lblYear.Text;
            switch (this.Tag.ToString())
            {
                case "ENROLL":                    
                    ComVar.Var.callForm = "10315";
                    break;
                case "DIRECT":
                    ComVar.Var.callForm = "10316";
                    break;
                case "CON_SERVICE":
                    ComVar.Var.callForm = "10317";
                    break;
                case "TO_PO":
                    ComVar.Var.callForm = "10320";
                    break;
                default:
                    break;
            }
