    ...
    public partial class Main : Form
    {
        ...
        */
        ...
        private void setIcon()
        {
            try
            {
                string path = Application.StartupPath + @"\icon.Ico";
        ...
        private void runSingleForm()
        {
            Assembly assembly = Assembly.LoadFile(Application.StartupPath + @"\DLL\SMT_QUALITY_COCKPIT_EXTERNAL_OSD.DLL");
            Type type = assembly.GetType("FORM.SMT_QUALITY_COCKPIT_EXTERNAL_OSD");
            _dt = SEL_GET_FORM_DLL("SMT_QUALITY_COCKPIT_EXTERNAL_OSD");
        ...
        private void runGroupForm()
        {
            try
            {
                ...
                ComVar.Var._Area = _dtXML.Rows[0]["AREA"].ToString() + ".";
        ...
        private void addForm(string argDll, string argClass)
        {
            try
            {
                ...
                form.Bounds = new Rectangle(0, 0, pnMain.Width, pnMain.Height);
                pnMain.Controls.Add(form);
               // form.Show();
               // form.Hide();
        ...
        private void showFormBack()
        {
            ...
            try
            {
                ...
                {
                    if (ComVar.Var._List_Back[i].Item1 == ComVar.Var._Frm_Curr && ComVar.Var._List_Back[i].Item1 != ComVar.Var._List_Back[i].Item2)
                    {
