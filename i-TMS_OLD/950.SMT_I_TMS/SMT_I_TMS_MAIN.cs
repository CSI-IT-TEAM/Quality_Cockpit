...
namespace FORM
{
    public partial class SMT_I_TMS_MAIN : Form
    {
        public SMT_I_TMS_MAIN()
        {            
            InitializeComponent();
            initForm();
       ...
       // Dictionary<string, UC.UC_Chart_Donut> _dicLocation = new Dictionary<string, UC.UC_Chart_Donut>();
        ...
        private void create_Line(Panel pnControl, DataTable argDt, int locStartX, int locStartY)
        {
            ...
            Font lineTextButtonFont = new System.Drawing.Font("Calibri", 11F, System.Drawing.FontStyle.Bold);
            ...
            Size lineButtonSize = new System.Drawing.Size(50, 27);
            ...
            dicValue["NAME"] = "cmd_PROD" + factory + "_TXT";
            dicValue["TEXT"] = "Prod";
            dicValue["TAG"] = "";
            cmdLine = createButton(dicValue, buttonLoc, lineTextButtonSize, lineTextButtonFont);
            pnControl.Controls.Add(cmdLine);
            ...
            lineTextButtonSize = new System.Drawing.Size(buttonStatusSize.Width, sizeTextHead);
            dicValue["NAME"] = "cmd_ISB" + factory + "_TXT";
            dicValue["TEXT"] = "ISB";
            dicValue["TAG"] = "";
            cmdLine = createButton(dicValue, buttonLoc, lineTextButtonSize, lineTextButtonFont);
            pnControl.Controls.Add(cmdLine);
            ...
            lineTextButtonSize = new System.Drawing.Size(buttonStatusSize.Width, sizeTextHead);
            dicValue["NAME"] = "cmd_PRE" + factory + "_TXT";
            dicValue["TEXT"] = "Pre";
            dicValue["TAG"] = "";
            cmdLine = createButton(dicValue, buttonLoc, lineTextButtonSize, lineTextButtonFont);
            pnControl.Controls.Add(cmdLine);
            ...
            lineTextButtonSize = new System.Drawing.Size(buttonStatusSize.Width, sizeTextHead);
            dicValue["NAME"] = "cmd_TMS" + factory + "_TXT";
            dicValue["TEXT"] = "TMS";
            dicValue["TAG"] = "";
            cmdLine = createButton(dicValue, buttonLoc, lineTextButtonSize, lineTextButtonFont);
            pnControl.Controls.Add(cmdLine);
        ...
        private void pnFactory_Click(object sender, EventArgs e)
        {
            try
            {
                ComVar.Var.callForm = "960";
            }
            catch { }
        }
    }
